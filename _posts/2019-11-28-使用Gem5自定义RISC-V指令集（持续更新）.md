...
下面是仿真的结果，我们先来看一下：
```
llvm@llvm-vm:~/workspace/gem5$ ./build/RISCV/gem5.debug configs/example/se.py -c tests/test-progs/hello_haawking/hello --output=sim.out --errout=sim.err
gem5 Simulator System.  http://gem5.org
gem5 is copyrighted software; use the --copyright option for details.
...
```
```
llvm@llvm-vm:~/workspace/gem5$ ./build/RISCV/gem5.debug configs/example/se.py -c tests/test-progs/mod_test/mod_test --output=sim.out --errout=sim.err
gem5 Simulator System.  http://gem5.org
gem5 is copyrighted software; use the --copyright option for details.
